"""
Kjør full datahenting for Haugesund – salg og leie.

Bruk:
    python run_haugesund.py              # henter BÅDE salg og leie
...
from eiendom_analyse_claude.storage.json_store import save_or_merge, load_objects
...
SALG_URL = (
    ...
    "?filters=&location=1.20012.20197"
    "&lifecycle=1&is_new_property=false"
    "&ownership_type=3&ownership_type=4"
)
SALG_UT = "Data/finn_Haugesund_estates.json"

LEIE_URL = "https://www.finn.no/realestate/lettings/search.html?location=1.20012.20197"
LEIE_UT  = "Data/finn_Haugesund_utleie.json"
...
def run_salg(geocode: bool = True) -> None:
    ...
    print("\n✅ Salg Haugesund ferdig!\n")


def run_leie(geocode: bool = True) -> None:
    print("\n" + "="*50)
    print("  LEIE – Haugesund")
    print("="*50)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Hent FINN-data for Haugesund")
